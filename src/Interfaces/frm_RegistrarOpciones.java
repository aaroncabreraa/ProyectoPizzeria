 ...
 * @author EiruonzOK
 */
public class frm_RegistrarOpciones extends javax.swing.JFrame {

   
    public frm_RegistrarOpciones() {
        initComponents();
    ...
    private void initComponents() {
        ...
        cmb_opcion.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "----------------", "Administrador", "Mesero" }));
        ...
        getContentPane().add(cmb_opcion, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 100, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_RegistrarOpciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_RegistrarOpciones().setVisible(true);
            }
        });
    }
