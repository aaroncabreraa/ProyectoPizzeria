...
import static Interfaces.frm_BuscarClientes.user_update;

/**
 *
 * @author EiruonzOK
 */
public class frm_BuscarAdministrador extends javax.swing.JFrame {
    public static String user_update = "";
    /**
     * Creates new form frm_SearchAdministrator
     */
    public frm_BuscarAdministrador() {
        initComponents();
        ...
        tablaAdministradores.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent e){
                ...
                if (fila_point > -1) {
                    ...
                    frm_InformacionAdministrador ad = new frm_InformacionAdministrador();
                    ad.setVisible(true);
                }
    ...
    private void initComponents() {
        ...
        getContentPane().add(txt_Buscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 130, 230, 40));
        ...
        getContentPane().add(btnBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 130, 40, 40));

        btnEliminar4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/filled_trash_32px.png"))); // NOI18N
        btnEliminar4.setBorder(new javax.swing.border.MatteBorder(null));
        btnEliminar4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnEliminar4ActionPerformed(evt);
            }
        });
        getContentPane().add(btnEliminar4, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 130, 40, 40));
    ...
    private void btnEliminar4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminar4ActionPerformed
        ...
        String buscar=txt_Buscar.getText().trim();
        fun.eliminarAdministrador(buscar);
        mostrar("");
        txt_Buscar.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_BuscarAdministrador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_BuscarAdministrador().setVisible(true);
            }
        });
    }
