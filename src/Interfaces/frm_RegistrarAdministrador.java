 ...
 * @author EiruonzOK
 */
public class frm_RegistrarAdministrador extends javax.swing.JFrame {

    public frm_RegistrarAdministrador() {
        initComponents();
        setTitle("Registrar nuevo Administrador");
        setSize(632, 380);//mantener el tamaño de la interfaz para que no se pueda editar
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, 80, 20));
        ...
        getContentPane().add(txt_username, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 140, 210, -1));
        ...
        getContentPane().add(txt_password, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 190, 210, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 230, 120, 100));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_RegistrarAdministrador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_RegistrarAdministrador().setVisible(true);
            }
        });
    }
