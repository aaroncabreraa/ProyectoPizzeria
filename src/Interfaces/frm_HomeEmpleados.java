 ...
 * @author EiruonzOK
 */
public class frm_HomeEmpleados extends javax.swing.JFrame {
    String user, nombre_usuario;
    public static int session_usuario;//enviar datos entreinterfacez
    public frm_HomeEmpleados() {
        initComponents();
        user = frm_Login.user;
        session_usuario = 1;//bandera 
        setSize(650, 430);
        setResizable(false);
        setTitle("Mesero - Sesión " + user);
    ...
    private void initComponents() {
        ...
        jButton_Menu.setBackground(new java.awt.Color(0, 102, 51));
        ...
        getContentPane().add(jButton_Menu, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 120, 100));

        jLabel4.setFont(new java.awt.Font("Arial Narrow", 1, 14)); // NOI18N
        jLabel4.setText("Menu ");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 140, -1, -1));

        jButton_Factura.setBackground(new java.awt.Color(0, 102, 51));
        ...
        getContentPane().add(jButton_Factura, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 30, 120, 100));
        ...
        jButton_AcercaDe.setBackground(new java.awt.Color(0, 102, 51));
        ...
        getContentPane().add(jButton_AcercaDe, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 170, 120, 100));
        ...
        getContentPane().add(jLabel_Wallpaper, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 370, 410));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_HomeEmpleados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_HomeEmpleados().setVisible(true);
            }
        });
    }
