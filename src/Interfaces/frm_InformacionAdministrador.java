 ...
 * @author EiruonzOK
 */
public class frm_InformacionAdministrador extends javax.swing.JFrame {
    String user_update = "";
    int ID;
    /**
     * Creates new form frm_InformationAdministrator
     */
    public frm_InformacionAdministrador() {
        initComponents();
        user_update = frm_BuscarAdministrador.user_update;
    ...
    private void initComponents() {
        ...
        getContentPane().add(txt_contrasena, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 290, 220, -1));
        ...
        getContentPane().add(txt_nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 80, 220, -1));

        txt_nombre5.setText("UserName");
        getContentPane().add(txt_nombre5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 230, -1, -1));
        getContentPane().add(txt_username, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 230, 220, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_InformacionAdministrador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_InformacionAdministrador().setVisible(true);
            }
        });
    }
