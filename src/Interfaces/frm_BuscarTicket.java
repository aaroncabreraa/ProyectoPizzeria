 ...
 * @author EduardoMtz
 */
public class frm_BuscarTicket extends javax.swing.JFrame {

    /**
     * Creates new form frm_SearchVoucher
     */
    public frm_BuscarTicket() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_BuscarTicket.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_BuscarTicket().setVisible(true);
            }
        });
    }
