 ...
 * @author Frank
 */
public class frm_EmpleadosBuscDesc extends javax.swing.JFrame {

    /**
     * Creates new form frm_ChooseCustomersOption
     */
    public frm_EmpleadosBuscDesc() {
        initComponents();
    ...
    private void initComponents() {
        ...
        cmbMesero.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "---------------------------", "Buscar Meseros", "Descargar Meseros" }));
    ...
    private void cmbMeseroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbMeseroActionPerformed
        ...
        if (cmb==2) {
            frm_BuscarEmpleado sw =new frm_BuscarEmpleado();
            sw.setVisible(true);
        }else if (cmb==3) {
             try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_EmpleadosBuscDesc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_EmpleadosBuscDesc().setVisible(true);
            }
        });
    }
