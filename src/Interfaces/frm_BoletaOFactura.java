 ...
 * @author Frank
 */
public class frm_BoletaOFactura extends javax.swing.JFrame {

    
    /**
     * Creates new form frm_ChooseVoucher
     */
    public frm_BoletaOFactura() {
        initComponents();
    ...
    private void cmbMeseroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbMeseroActionPerformed
        ...
        if (cmb==2) {
            frm_BuscarTicket t =new frm_BuscarTicket();
            t.setVisible(true);
        }else if (cmb==3) {
            frm_BuscarFactura b =new frm_BuscarFactura();
            b.setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_BoletaOFactura.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_BoletaOFactura().setVisible(true);
            }
        });
    }
